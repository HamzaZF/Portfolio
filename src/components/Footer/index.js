...
import { TbBrandX } from 'react-icons/tb'; // X (Twitter rebrand)
    ...
    <FooterContainer>
      <FooterWrapper>
        ...
        <SocialMediaIcons>
          ...
          <SocialMediaIcon href={Bio.twitter} target="_blank"><TbBrandX /></SocialMediaIcon>
        ...
        <Copyright>
          &copy; 2024 Hamza Zarfaoui. All rights reserved.
        </Copyright>
